...
# space_flights_tutorial documentation build
...
from space_flights_tutorial import __version__ as release

# -- Project information -----------------------------------------------------

project = "space_flights_tutorial"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "space_flights_tutorialdoc"
...
latex_documents = [
    (
        master_doc,
        "space_flights_tutorial.tex",
        "space_flights_tutorial Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "space_flights_tutorial",
        "Project space_flights_tutorial codebase.",
        "Data-Science",
    )
]
